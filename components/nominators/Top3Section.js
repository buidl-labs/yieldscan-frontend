...
const TopNominatorCard = ({
	...
	<div className="mt-4 px-10 py-8 flex-center flex-col border border-gray-200 rounded-lg shadow-lg">
		...
		<h5 className="font-semibold text-base">{totalStake}</h5>
		<span className="text-gray-600 font-semibold text-xs mt-4">
			Nominations
		</span>
		<h5 className="font-semibold text-base">{nominations}</h5>
	</div>
);
